...
export default function AdminButtonDasnboard({ iconAreaDash, textAreaDash,identifier,selectedButton,setSelectedButton }) {
    ...
    return (
        <button className='flex justify-center font-poppins cursor-pointer items-center  w-full group   rounded-l-xl relative   lg:p-4 py-4 px-6    ' onClick={()=> setSelectedButton(identifier)}>
