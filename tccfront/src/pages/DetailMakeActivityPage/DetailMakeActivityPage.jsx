  ...
  return (
    <div className='w-full font-poppins flex flex-col'>
      ...
      <div className='flex flex-col mx-auto items-center gap-y-6 mt-4 w-[80%]'>
        ...
        <div className='  w-full flex flex-wrap gap-x-4 gap-y-6 md:gap-y-0 md:justify-between items-center justify-center '>

          <CalygamActivityDetail />

          <div className='flex flex-col gap-y-3 items-center w-[250px] '>
            <div className='border p-2 border-calygam-purple-semi-strong w-full bg-green-950/10 backdrop-blur-2xl rounded-md'>
              <p className='text-xs font-bold'>Feedback</p>
            </div>
            <div className='border p-4 flex  gap-x-2 border-calygam-purple-semi-strong w-full bg-green-950/15 backdrop-blur-2xl rounded-md'>
