...
export default function FooterAssesment() {
    return (
        <div className=' mx-auto w-[95%] mb-16 flex font-poppins flex-col gap-y-2'>
            <div className='w-full flex h-[2px] rounded-full bg-calygam-purple-medium-light'></div>
            <div className='flex justify-between gap-y-2 flex-wrap  w-full mt-1 text-xs items-center'>
                <div>
                    <p className='text-nowrap'>© 2025 Calygam. Todos os direitos reservados.</p>
                </div>
                <div className='flex underline text-xs flex-wrap  items-center gap-x-2 justify-center'>
