                ...
                <div className='flex items-center   w-full pl-4 gap-2 z-10'>
                    ...
                    {iconAreaDash &&
                        <div className='flex items-center  gap-2'>
                            ...
                            <div>
                                <p className={`  ${identifier === selectedButton ? ` ${modifyStyles ? modifyStyles.selectedColorText : "text-red-clean-type font-semibold"}` : " text-white group-hover:text-calygam-strong-pink"}`}>{textAreaDash}</p>
                            </div></div>}
