            ...
            <a href={`${navRoute}`} className='flex justify-center outline-none font-poppins cursor-pointer items-center  w-full group   rounded-l-xl relative   lg:p-4 py-4 px-6    ' onClick={() => {
                ...
                {iconAreaDash ?
                    <div className='absolute w-full    group h-full flex justify-end p-1 '>
                        <div className={`  delay-0 duration-[750ms] w-0 ease-in-out  group-hover:rounded-full group-hover:w-full   group-hover:h-full bg-gradient-to-tr from-purple-600/75 via-purple-800   to-purple-900/75 ${identifier === selectedButton ? "w-full rounded-l-xl " : "w-0 bg-transparent "}`}></div>
