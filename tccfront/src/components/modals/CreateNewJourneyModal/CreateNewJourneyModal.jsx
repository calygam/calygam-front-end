          ...
          <div className="flex flex-col items px-4  ">
              ...
              {!targetTrailId &&
                <div className='flex w-full items-center justify-between'>
                  ...
                  <div className='flex w-[45%]  flex-col'>
                    <div className=" border rounded-md md:mx-0 flex    focus:outline-none  outline-none ">
                      <input
            ...
            <div className="w-full flex flex-wrap md:flex-nowrap gap-x-4 justify-center md:justify-between items-center my-2">
              ...
              <div className="w-[65%] flex justify-between">
                <span className="w-[40px] h-[40px] hidden border-2 border-black md:flex rounded-full"></span>
        ...
        ${imagePreview ? "p-0" : "p-4 min-h-[150px]"}`}
                  >
                    {imagePreview ? (
                      ...
                      "Toque ou clique para selecionar uma imagem - Limite de 30kb"
                    )}
                  </label>
                  <p id="image-desc" className="text-gray-600 text-xs font-bold my-2">Imagem (Max: 30kb)</p>
                </div>
              </div>
              <input
                type="file"
          ...
          {step > 0 && (
            <div className='flex w-full justify-between flex-wrap items-center gap-y-2 '>
              ...
              {step >= 10 || form?.activities.length >= 10 ?
                <button type='button' disabled={!(isFormValid || formErrors.trailPassword === "" || isValidActivity) || !imagePreview} className={`outline-none py-2 px-4  h-[45px] ${!(isFormValid || isValidActivity || formErrors.trailPassword === "") || !imagePreview ? "bg-purple-600/45 cursor-not-allowed text-white/45 border-none" : "bg-purple-600 border-purple-700"} border-b-4 hover:translate-y-[2px] transition-all   rounded-md text-white text-black/35  hover:border-b-0`} onClick={(e) => submitForm(e)}>Enviar</button>
